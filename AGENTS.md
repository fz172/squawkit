...
- `docs/product/` — `PRD.md` (product overview), `multi_domain_maintenance_PRD.html` (proposed pivot from aircraft-only to any maintainable "Thing" via a template configuration system), `platform_feature_parity.html` (Android/iOS/web feature matrix)
