 ...
 * there. Foundational/infrastructure modules a feature happens to need (lifecycle, storage, …) stay
 * registered directly in `commonAppModules` rather than folded in here — this bundles the
 * notification feature's own business modules only.
 */
