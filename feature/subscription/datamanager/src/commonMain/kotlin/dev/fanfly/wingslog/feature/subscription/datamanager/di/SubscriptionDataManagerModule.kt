...
import dev.fanfly.wingslog.feature.subscription.datamanager.impl.FirebasePromoCodeRedeemer
...
val subscriptionDataManagerModule = module {
  ...
  single<PromoCodeRedeemer> { FirebasePromoCodeRedeemer(get<FirebaseFunctions>()) }
