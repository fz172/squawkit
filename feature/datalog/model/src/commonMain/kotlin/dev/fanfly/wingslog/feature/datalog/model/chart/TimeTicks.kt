...
object TimeTicks {
  ...
  val STEP_LADDER: IntArray = intArrayOf(5, 10, 30, 60, 120, 300, 600, 900, 1800, 3600)
  ...
  fun step(spanSeconds: Int, widthPx: Int, minLabelSpacingPx: Float): Int {
    ...
    return STEP_LADDER.firstOrNull { it * pxPerSecond >= minLabelSpacingPx } ?: STEP_LADDER.last()
  }
  ...
  fun labelCenterX(tickX: Float, labelWidthPx: Float, widthPx: Int): Float =
    tickX.coerceIn(labelWidthPx / 2f, (widthPx - labelWidthPx / 2f).coerceAtLeast(labelWidthPx / 2f))
}
