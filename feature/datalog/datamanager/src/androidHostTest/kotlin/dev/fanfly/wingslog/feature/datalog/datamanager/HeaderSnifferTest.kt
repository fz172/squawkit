...
class HeaderSnifferTest {
  ...
  fun g3xHeaderIsDefinite() {
    ...
    assertThat(garmin.sniff(Fixtures.bytes(Fixtures.GROUND_RUN).copyOf(HeaderSniffer.SNIFF_BYTES)))
      .isEqualTo(Confidence.DEFINITE)
  }
  ...
  fun wrongFilesAreNone() {
    ...
    assertThat(sniff("<html><body>not a log</body></html>")).isEqualTo(Confidence.NONE)
    assertThat(garmin.sniff(byteArrayOf(0x50, 0x4B, 0x03, 0x04, -1, -2, 0, 0x7f))).isEqualTo(Confidence.NONE)
  }
