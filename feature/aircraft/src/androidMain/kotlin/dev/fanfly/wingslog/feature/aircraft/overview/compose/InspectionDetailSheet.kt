...
private fun DueStatusChip(dueStatus: DueStatus) {
    val (label, color) = when {
        ...
        dueStatus.nextDueDate != null -> stringResource(R.string.due_date, dueStatus.nextDueDate?.toJavaLocalDate()?.format(dateFormatter) ?: "") to StatusOk
        dueStatus.nextDueTach != null -> stringResource(R.string.due_tach, String.format(Locale.getDefault(), "%.1f", dueStatus.nextDueTach ?: 0f)) to StatusOk
