...
private fun LogStatsSection(stats: LogStats, modifier: Modifier = Modifier) {
  Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(8.dp)) {
    Text(
      text = stringResource(R.string.maintenance_summary),
      style = MaterialTheme.typography.titleMedium,
      fontWeight = FontWeight.Bold
    )
    ...
    Row(
      ...
      StatCard(
        label = stringResource(R.string.total_logs),
        value = stats.total.toString(),
        modifier = Modifier.weight(1f)
      )
      StatCard(
        label = stringResource(R.string.airframe),
    ...
    Row(
      ...
      StatCard(
        label = stringResource(R.string.propeller),
