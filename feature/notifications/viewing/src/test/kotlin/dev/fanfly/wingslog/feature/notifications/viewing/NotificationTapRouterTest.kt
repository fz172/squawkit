...
class NotificationTapRouterTest {
  ...
  fun encodeThenDeliver_squawk_roundTrips() {
    val target = NotificationTapTarget.Squawk(aircraftId = "ac-1", squawkId = "sq-1")
  ...
  fun encodeThenDeliver_task_roundTrips() {
    val target = NotificationTapTarget.Task(aircraftId = "ac-1", taskId = "task-1")
  ...
  fun encodeThenDeliver_aircraftWithTab_roundTrips() {
    val target = NotificationTapTarget.Aircraft(aircraftId = "ac-1", tab = "tasks")
  ...
  fun deliver_unrelatedUri_returnsFalse_andDeliversNothing() {
    val delivered = NotificationTapRouter.deliver("https://example.com/whatever")
  ...
  fun deliver_malformedNotificationUri_returnsFalse() {
    ...
    val delivered = NotificationTapRouter.deliver("wingslog://notification-tap/squawk/ac-1")
  ...
  fun consume_clearsPending() {
    NotificationTapRouter.deliver(NotificationTapRouter.encode(NotificationTapTarget.Aircraft("ac-1")))
