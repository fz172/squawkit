...
@Composable
actual fun rememberExportFileSharer(): ExportFileSharer = remember { WebExportFileSharer() }
...
private class WebExportFileSharer : ExportFileSharer {
  override fun share(
    ...
    val href = "mailto:?subject=${encodeUriComponent(subject)}&body=${encodeUriComponent(body)}"
    return runCatching {
