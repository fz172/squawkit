...
class LocalFirstAttachmentManagerImplTest {
  ...
  @Test
  fun addPickedFile_compressesPhoto_storesCompressedBytesAndRewritesMetadata() =
    runTest {
      val picked =
        buildPickedFile(mimeType = "image/jpeg", sizeBytes = 4_000_000L)
  ...
  @Test
  fun addPickedFile_photoStillOverCapAfterCompression_throwsFileTooLarge() =
    runTest {
      val picked =
        buildPickedFile(mimeType = "image/jpeg", sizeBytes = 9_000_000L)
      val rawBytes = byteArrayOf(1, 2, 3)
