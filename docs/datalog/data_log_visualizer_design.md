...
| Coil                  | `core/ui/.../core/ui/avatar/CircularImage.kt:64-74`                                                                                                                              | `rememberAsyncImagePainter` is the house pattern; default singleton loader; ktor engine bound for Android and iOS, **not** in `webApp`                      |
